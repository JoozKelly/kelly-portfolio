...
const Contact = () => {
  ...
  const [currentAnimation, setCurrentAnimation] = useState('Take 001')
  ...
  const handleSubmit = (e) => {
    ...
    emailjs.send(
      ...
      import.meta.env.VITE_APP_EMAILJS_TEMPLATE_ID,
      {
        ...
        to_email: 'joozkelly12@gmail.com',
  ...
  const handleBlur = () => setCurrentAnimation('Take 001');
  
  return (
    <section className='relative flex lg:flex-row flex-col 
    max-container h-full'>
      ...
      <div className="lg:w-1/2 w-full lg:h-auto md:h=[550px] h-[350px]">
        ...
        >
          <directionalLight intensity={5} position={[0.5, 0.5, 1]} />
          <ambientLight intensity={0.5} />
          <Suspense fallback={<Loader />}>
            <Robo 
            currentAnimation={currentAnimation}
              position={[0.5, -1, 0]}
              rotation={[12.7, -0.6, 0.05]}
              scale={[0.8, 0.8, 0.8]}
            />
          </Suspense>
